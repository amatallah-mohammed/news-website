...
$id=$_GET['id'];
foreach ($categories->oneCategory($id) as $category)
{
    $id= $category->cat_id;
    $name= $category->name;
                ...
                <div class="card-body p-0">
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" >
                        ...
                        <div class="form-group inputmy">
                            ...
                            <input type="text" name="name" class="form-control" id="title" aria-describedby="emailHelp" placeholder="Name" value="<?php if(isset($name)) echo $name; ?>" required autocomplete="off">

                        </div>
                        <div class="form-group inputmy">
                            <label>State</label>
                            <select name="category_state" class="form-control" >
                                <option><?php if(isset($state)) echo $state; ?></option>
                        ...
                        <div class="form-group inputmy">
                            ...
                            <select name="category_parent" class="form-control" >
                                <option><?php if(isset($parent)) echo $parent; ?></option>
